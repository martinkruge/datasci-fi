...
customer_similarities.order <- cos.sim(ordered_products_wide.order, ordered_products_wide.order)
diag(customer_similarities.order) <- 0
#------------------------------------------------------------------
# 2. Similarity matrix based on quantities per product
customer_similarities.quantity <- cos.sim(ordered_products_wide.quantity, ordered_products_wide.quantity)
diag(customer_similarities.quantity) <- 0
#------------------------------------------------------------------
# 3. Similarity matrix based on order count per product
customer_similarities.count <- cos.sim(ordered_products_wide.count, ordered_products_wide.count)
diag(customer_similarities.count) <- 0
#------------------------------------------------------------------

# Very sparse matrix's
image(customer_similarities.order)
image(customer_similarities.quantity)
image(customer_similarities.count)
...
[14] Wikipedia: Cosine similarity [link](https://en.wikipedia.org/wiki/Cosine_similarity) 
